...
<head>
    ...
    <meta name="description" content="Roshan Jha Web Development Full Stack Developer">
...
<body>
    ...
    <div class="sidebar clearfix">
        ...
        <ul class="sidebar-panel nav">
            ...
            <li><a href="{{route('manage-portfolio')}}"><span class="icon color7"><i class="fa fa-code-fork"></i></span>Manage Projects</a></li>
